...
#[*BSc in Data Science*] #h(1fr) 2020 -- 2023 \
School of Applied Mathematics, Getulio Vargas Foundation, Brazil. GPA: 9.9/10.0. \
...
- Postdoctoral Associate under supervision of #link("https://lahlou.org/")[Salem Lahlou]. #h(1fr) 2025/10 -- ongoing
  - Designing algorithms for amortized Bayesian inference.
...
== Selected Publications (#link("https://scholar.google.com/citations?user=FLBHiI0AAAAJ&hl=pt-BR")[Google Scholar])
#chiline()
...
Human languages: Portuguese (Native), English

Computer languages: Proficient with #underline[Python] and #underline[SQL]. Competent with R and Stan and Rust.
...
#link("mailto:diego.mesquita@fgv.br")[Diego Mesquita], #link("mailto:amauri.souza@aalto.fi")[Amauri Souza]
